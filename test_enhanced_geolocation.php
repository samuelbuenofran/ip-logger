                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-<?php
                                                                            echo $target['device_type'] === 'mobile' ? 'success' : ($target['device_type'] === 'tablet' ? 'warning' : 'primary');
                                                                            ?>">
                                                        <i class="fas fa-<?php
                                                                            echo $target['device_type'] === 'mobile' ? 'mobile-alt' : ($target['device_type'] === 'tablet' ? 'tablet-alt' : 'desktop');
                                                                            ?>"></i>
