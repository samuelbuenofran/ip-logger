...
class EnhancedGeolocation
{
    ...
    private function applyMLRefinement($location_data)
    {
        ...
        if (
            isset($location_data['historical_analysis']) &&
    ...
    private function applyRuleBasedRefinement($location_data, $refined)
    {
        ...
        if (
            isset($location_data['network_analysis']['mobile_network']) &&
        ...
        if (
            isset($location_data['network_analysis']['vpn_detected']) &&
        ...
        // Data center penalty
        if (
            isset($location_data['network_analysis']['data_center']) &&
